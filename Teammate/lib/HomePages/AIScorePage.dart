...
class AIScorePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('역량 진단', style: TextStyle(fontFamily: 'Roboto', fontWeight: FontWeight.w900, color: Colors.black, letterSpacing: 1.5, fontSize: 16)),
        backgroundColor: const Color(0xFFFAFAFA),
        elevation: 0,
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "직군을\n선택해주세요.",
              style: TextStyle(fontSize: 36, fontWeight: FontWeight.w300, height: 1.2, color: Colors.black, letterSpacing: -1.0),
            ),
