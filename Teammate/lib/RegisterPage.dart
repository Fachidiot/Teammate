...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _nextClicked(List<String> positions) {
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: FutureBuilder<DocumentSnapshot>(
                  future: FirebaseFirestore.instance.collection('metadata').doc('positions').get(),
                  builder: (context, snapshot) {
                    ...
                    final positions = List<String>.from(snapshot.data!['list'] ?? []);
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () => _nextClicked(positions),
                            child: const Text('다음'),
                          ),
                        ),
                      ],
